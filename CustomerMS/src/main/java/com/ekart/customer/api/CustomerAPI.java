...
//		List<ServiceInstance> list1 = client.getInstances("ProductMS");
//		 String uri=null;
//		    if (list1 != null && list1.size() > 0 )
//		    {
//		        uri=list1.get(0).getUri().toString();
//		    }
...
//		List<ServiceInstance> list2 = client.getInstances("CartMS");
//		    if (list2 != null && list2.size() > 0 )
//		    {
//		        uri=list2.get(0).getUri().toString();
//		    }
